...
- create a virtual env - ```uv venv --python 3.12 venv  ```
- activate the venv - ```venv\Scripts\activate```
- install dependency modules - ```uv pip install -r requirements.txt```
- check the responses of agent corresponding to your logs - 
